...
public class TransportPlane extends Plane{
    ...
    private Double weightPossibility;
    public TransportPlane(String name, Double weight, Double fuelConsumption, Double tankVol,  String companyOwner, Double weightPossibility) {
